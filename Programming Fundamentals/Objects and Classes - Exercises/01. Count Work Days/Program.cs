...
namespace _01.Count_Work_Days
{
    class Program
    {
        static void Main()
        {
            ...
            DateTime startDate=DateTime.ParseExact(firstDate,"dd-MM-yyyy",CultureInfo.InstalledUICulture);
            DateTime endDate=DateTime.ParseExact(secondDate,"dd-MM-yyyy",CultureInfo.InstalledUICulture);
